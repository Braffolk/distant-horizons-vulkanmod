...
import net.fabricmc.fabric.api.networking.v1.PayloadTypeRegistry;#else
import com.seibel.distanthorizons.core.network.messages.AbstractNetworkMessage;#endif

#if MC_VER<MC_1_19_4
import java.nio.FloatBuffer;#endif
import java.util.HashSet;
import java.util.concurrent.AbstractExecutorService;

#if MC_VER<MC_1_21_9
import net.fabricmc.fabric.api.client.rendering.v1.WorldRenderEvents;#endif
...
public class FabricClientProxy implements AbstractModInitializer.IEventProxy {
	...
	private static final AbstractPluginPacketSender PACKET_SENDER = (AbstractPluginPacketSender) SingletonInjector.INSTANCE
