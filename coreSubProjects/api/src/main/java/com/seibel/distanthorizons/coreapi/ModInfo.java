...
public final class ModInfo {
	...
	/**
	 * Incremented every time any packets are added, changed or removed, with a few
	 * exceptions.
	 */
	...
	public static final String VERSION = "2.4.6-vm.4";
	/**
	 * Returns true if the current build is an unstable developer build, false
	 * otherwise.
	 */
	public static final boolean IS_DEV_BUILD = VERSION.toLowerCase().contains("dev");

	/**
	 * This version should only be updated when breaking changes are introduced to
	 * the DH API
	 */
	...
	/**
	 * This version should be updated whenever non-breaking fixes are added to the
	 * DH API
	 */
	...
	/**
	 * All DH owned threads should start with this string to allow for easier
